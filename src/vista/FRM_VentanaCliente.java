 ...
 * @author 3rika
 */
public class FRM_VentanaCliente extends javax.swing.JFrame {

    /**
     * Creates new form FRM_VentanaCliente
     */
    public Controlador_VentanaArticulo controladorVentana;
    
    public FRM_VentanaCliente() {
        initComponents();
        controladorVentana = new Controlador_VentanaArticulo(this);
    ...
    {
        return this.panel_Informacion1.devolverCodigo();
    ...
    {
        this.panel_Informacion1.mostrarInformacionRegistro(informacion);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRM_VentanaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRM_VentanaCliente().setVisible(true);
            }
        });
    }
